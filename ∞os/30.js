 ...
 */
const a=new WeakMap,o=Object(s.e)(t=>e=>{if(!(e instanceof s.b))throw new Error("unsafeHTML can only be used in text bindings");const i=a.get(e);if(void 0!==i&&Object(n.h)(t)&&t===i.value&&e.value===i.fragment)return;const o=document.createElement("template");o.innerHTML=t;const r=document.importNode(o.content,!0);e.setValue(r),a.set(e,{value:t,fragment:r})})},814:function(t,e,i){"use strict";i.r(e),i.d(e,"Imodal",(function(){return c}));i(7);var n=i(1),s=i(431),a=(i(470),i(161)),o=i(0),r=function(t,e,i,n){var s,a=arguments.length,o=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,i,n);else for(var r=t.length-1;r>=0;r--)(s=t[r])&&(o=(a<3?s(o):a>3?s(e,i,o):s(e,i))||o);return a>3&&o&&Object.defineProperty(e,i,o),o};let c=class extends n.a{constructor(){super(...arguments),this.step="loading"}showError(){this.step="error"}async reUpdate(){a.slave.sendMessage("tabs-reload"),setTimeout(()=>{location.reload()},0)}async showRepair(){if(this.step=null,document.querySelector("i-updating").classList.add("hide"),localStorage.setItem("user-checkout-repair",o.y),localStorage.getItem("updating-manual"))return;const{pluginStore:t}=await Promise.all([i.e(1),i.e(35)]).then(i.bind(null,430));t.showRepair()}render(){return"loading"===this.step?n.e`
